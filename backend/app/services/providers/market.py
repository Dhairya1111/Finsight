...
class YahooFinanceMarketProvider(MarketDataProvider):
    ...
    def get_company(self, symbol: str) -> CompanyOverview:
        ...
        if regular_market_time:
            price_as_of = __import__("datetime").datetime.fromtimestamp(regular_market_time).isoformat()
        ...
        return CompanyOverview(
            ...
            price_change=self._safe_float(price_change),
            price_change_percent=self._safe_float(price_change_percent),
